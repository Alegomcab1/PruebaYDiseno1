...
public class CustomerController extends AbstractController {
	...
	@RequestMapping(value = "/shoutsList", method = RequestMethod.GET)
	public ModelAndView action1() {
		...
		result = new ModelAndView("customer/shoutsList");
		result.addObject("shouts", shouts); // TODO: Ponerlo en el README.TXT
	...
	@RequestMapping(value = "/addShout", method = RequestMethod.GET)
	public ModelAndView action2Get() {
		...
		result = new ModelAndView("customer/addShout");
	...
	public ModelAndView action2Post(@Valid final Shout shout, final BindingResult binding) {
		...
		if (!binding.hasErrors()) {
			...
			result = new ModelAndView("redirect:shoutsList.do");
		} else {
			result = new ModelAndView("customer/addShout");
			result.addObject("shout", shout);
		}
