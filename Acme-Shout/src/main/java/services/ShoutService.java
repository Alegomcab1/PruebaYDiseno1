...
public class ShoutService {
	...
	public Map<String, Double> computeStatistics() {
		...
		countAll = (double) this.shoutRepository.countAllShouts();
		countShort = (double) this.shoutRepository.countShortShouts();
		countLong = (double) this.shoutRepository.countLongShouts();
